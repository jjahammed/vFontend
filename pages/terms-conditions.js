...
function BlogDetails() {
  return (
    <>
      <Head>
        <title>Vegas Web's Terms of Use</title>
        ...
        <meta
          property="og:title"
          content="Vegas Web's Terms of Use"
        />
      ...
      <section>
          <div className="container">
            ...
            <div className="terms-conditions">
              <h1 className="policy-sec-title">Terms And Condition</h1>
              <h2 className="pp-sm-title">1. Acceptance of Terms</h2>
              ...
              <br />
              <h3 className="pp-sm-title">2. Privacy Policy  </h3>
              <p className="urbanist-black-16">
              ...
              <br />
              <h3 className="pp-sm-title">3. The Services </h3>
              <p className="urbanist-black-16">
              ...
              <br />
              <p>Subject to your continued compliance with this Agreement, including timely payment of associated amounts due, we grant you a limited, revocable, non-exclusive, non-sublicensable, non-transferable license to access and use the Services for your internal business purposes. </p>
              <br />
              <p className="urbanist-black-16">
              ...
              <br />
              <h3 className="pp-sm-title">4. Use of the Services </h3>
              <p className="urbanist-black-16">
              ...
              <br />
              <h3 className="pp-sm-title">5. Use of Stock Services </h3>
              <p className="urbanist-black-16">
              ...
              <h3 className="pp-sm-title">6. Fees</h3>
              <p className="urbanist-black-16">
              ...
              <br />
              <h2 className="pp-sm-title">7. Confidential Information  </h2>
              <p className="urbanist-black-16">
              ...
              <br />
              <h2 className="pp-sm-title">9. Term and Termination </h2>
              <p className="urbanist-black-16">
              ...
              <br />
              <p>If you default or violate this Agreement, we may end this Agreement at any time with notice.  You immediately lose all access to the applicable Service, including access to your account and Customer Content or other files, upon expiration or cancellation of your account or subscription to a Service. This affects all rights you may have under this Agreement with regard to that Service.  Any licenses to Licensed Content will expire in the event that we terminate the Agreement due to your violation. </p>
              <br />
              <h2 className="pp-sm-title">10. Disclaimer of Warranties </h2>
              <p className="urbanist-black-16">
              ...
              <br />
              <h2 className="pp-sm-title">11. Liability Waiver </h2>
              <p className="urbanist-black-16">
              ...
              <br />
              <h2 className="pp-sm-title">12. Indemnification </h2>
              <p className="urbanist-black-16">
              ...
              <br />
              <h2 className="pp-sm-title">13. Links to Third-Party Platforms </h2>
              <p className="urbanist-black-16">
              ...
              <br />
              <h2 className="pp-sm-title">14. Digital Millennium Copyright Act </h2>
              <p className="urbanist-black-16">
              ...
              <br />
              <p>The parties shall submit any dispute arising out of or relating to this Agreement to binding arbitration administered by the International Centre for Dispute Resolution in Phoenix, Arizona in accordance with its International Arbitration Rules, if it is determined that no court in Maricopa County, Arizona has jurisdiction. For the advantage of both parties, the arbitration process in its entirety as well as any rule, decision, or award made by the arbitrator shall be kept entirely confidential. </p>
              <br />
              <p>The parties acknowledge and agree that each of us may only bring claims against the other on an individual basis, and not as a plaintiff or class member in any purported class or representative action or proceeding.</p>
              <br />
              <p>THE PARTIES AGREE THAT ANY ACTION OR CLAIM ARISING OUT OF OR RELATING TO THESE TERMS OF USE MUST BE STARTED WITHIN ONE (1) YEAR AFTER THE CAUSE OF ACTION AROSE, OTHERWISE, SUCH ACTION OR CLAIM IS PERMANENTLY BARRED. </p>
            
              <br />
              <h2 className="pp-sm-title">16. Assignment </h2>
              <p className="urbanist-black-16">
              ...
              <br />
              <h2 className="pp-sm-title">17. Severability  </h2>
              <p className="urbanist-black-16">
              ...
              <br />
              <h2 className="pp-sm-title">18. Non-Waiver  </h2>
              <p className="urbanist-black-16">
              ...
              <br />
              <h2 className="pp-sm-title">19. Force Majeure </h2>
              <p className="urbanist-black-16">
              ...
              <br />
              <h2 className="pp-sm-title">20. Entire Agreement </h2>
              <p className="urbanist-black-16">
