    ...
    <div className="data_center cpy-8">
        <div className="container">
            ...
            data-aos-duration="2000">
                    <img src="../Images/ChainUp/chainUp.png" alt="vages Web"/>
                </div>
            ...
            data-aos-duration="2500">
                    ...
                    <div className="row gap-4 data_center_right_box">
                        <div className="col data_center_box_items align-items-center">
                            <img src="../Images/ChainUp/1.svg" alt="vages Web" width="61" height="61"/>
                        ...
                        <div className="col data_center_box_items align-items-center">
                            <img src="../Images/ChainUp/2.svg" alt="vages Web" width="61" height="61"/>
                            <div className="data_center_box_items_title">
                        ...
                        <div className="col data_center_box_items align-items-center">
                            <img src="../Images/ChainUp/3.svg" alt="vages Web" width="61" height="61"/>
                            <div className="data_center_box_items_title ">
                        ...
                        <div className="col data_center_box_items align-items-center">
                            <img src="../Images/ChainUp/4.svg" alt="vages Web" width="61" height="61"/>
                            <div className="data_center_box_items_title">
                        ...
                        <div className="col data_center_box_items align-items-center">
                            <img src="../Images/ChainUp/5.svg" alt="vages Web" width="61" height="61"/>
                            <div className="data_center_box_items_title">
                        ...
                        <div className="col data_center_box_items align-items-center">
                            <img src="../Images/ChainUp/6.svg" alt="vages Web" width="61" height="61"/>
                            <div className="data_center_box_items_title">
