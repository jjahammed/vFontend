...
function SocialMediaGraphic({project}) {
  ...
  const firstSlide  = project.filter(res => res.section == 'social-media' && res.sub_section == 1)
  const secondSlide  = project.filter(res => res.section == 'social-media' && res.sub_section == 2)
  const thirdSlide  = project.filter(res => res.section == 'social-media' && res.sub_section == 3)


  return (
    <>
      {/* <!-- ============== Our Imagine start ======================  --> */}
      <section className="imagine cpb-7 cpt-7"   data-aos="fade-up"
...
export default SocialMediaGraphic;
