              ...
              <div className="registration_icons">
                <div className="row text-center g-5 d-flex align-items-center justfiy-content-center">
                  <div className="col-6 col-lg-4 col-md-4 col-sm-6">
                    <img src="../Images/logo_section/1.png" alt="vegas web" />
                  </div>
                  <div className="col-6 col-lg-4 col-md-4 col-sm-6">
                    <img src="../Images/logo_section/2.png" alt="vegas web" />
                  </div>
                  <div className="col-6 col-lg-4 col-md-4 col-sm-6">
                    <img src="../Images/logo_section/3.png" alt="vegas web" />
                  </div>
                  <div className="col-6 col-lg-4 col-md-4 col-sm-6">
                    <img src="../Images/logo_section/4.png" alt="vegas web" />
                  </div>
                  <div className="col-6 col-lg-4 col-md-4 col-sm-6">
                    <img src="../Images/logo_section/5.png" alt="vegas web" />
                  </div>
                  <div className="col-6 col-lg-4 col-md-4 col-sm-6">
                    <img src="../Images/logo_section/6.png" alt="vegas web" />
                  </div>
                </div>
              </div>
            </div>
