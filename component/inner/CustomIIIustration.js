...
function CustomIllustration({project}) {
    const onAutoplayTimeLeft = (s, time, progress) => {
      ...
      const firstSlide  = project.filter(res => res.section == 'custom-illustration' && res.sub_section == 1)
      const secondSlide  = project.filter(res => res.section == 'custom-illustration' && res.sub_section == 2)
      const thirdSlide  = project.filter(res => res.section == 'custom-illustration' && res.sub_section == 3)
